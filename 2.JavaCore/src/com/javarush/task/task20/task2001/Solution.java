...
public class Solution {
    public static void main(String[] args) {
        ...
        try {
            ...
            File your_file_name = File.createTempFile("b:\\aaa\\aaa.txt", null);
        ...
        public void load(InputStream inputStream) throws Exception {
            ...
            if (count > 0) {
                for (int i = 0; i < count; ++i) {
                    ...
                    String nameAsset = asset[0];
                    double priceAsset =  Double.parseDouble(asset[1]);
                    //System.out.println(nameAsset + " - " + priceAsset);
